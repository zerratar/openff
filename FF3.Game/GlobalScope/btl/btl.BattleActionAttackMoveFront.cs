...
internal static partial class GlobalScope
{
	...
	{
		public class BattleActionAttackMoveFront : BattleActionBase
		{
			public override void initialize(BattlePlayer player)
			{
				int num = -1;
				num = (player.condition().isFrog() ? 601 : ((!player.condition().isNearDeath() && !player.condition().isPoison()) ? 602 : 603));

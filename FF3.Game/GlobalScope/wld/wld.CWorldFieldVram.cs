...
internal static partial class GlobalScope
{
	...
	{
							public class CWorldFieldVram : CBaseWorldVram
							{
								...
								{
									ds.CVram.setMainPlaneVisiblity(bg0: true, bg1: false, bg2: true, bg3: true, obj: false);
								...
								{
									ds.CVram.getInstance().setupTexVramMng(393216u, 73728u, 64u, 0);

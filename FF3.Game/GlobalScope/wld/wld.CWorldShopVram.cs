...
internal static partial class GlobalScope
{
	...
	{
							public class CWorldShopVram : CBaseWorldVram
							{
								...
								{
									ds.CVram.setMainPlaneVisiblity(bg0: true, bg1: true, bg2: false, bg3: false, obj: false);
									ds.CVram.setSubPlaneVisiblity(bg0: true, bg1: true, bg2: false, bg3: false, obj: true);
									ds.CVram.setMainBGPriority(3, 2, 1, 0);
									ds.CVram.setSubBGPriority(3, 0, 2, 1);
									GX_SetGraphicsMode(GXDispMode.GX_DISPMODE_GRAPHICS, GXBGMode.GX_BGMODE_0, 0);
									GXS_SetGraphicsMode(GXBGMode.GX_BGMODE_0);
									G2_SetBG1Control(0, 0, GXBGScrBase.GX_BG_SCRBASE_0x1800, GXBGCharBase.GX_BG_CHARBASE_0x08000, 0);
									G2S_SetBG0Control(0, 0, GXBGScrBase.GX_BG_SCRBASE_0x0000, GXBGCharBase.GX_BG_CHARBASE_0x04000, 0);
									G2S_SetBG1Control(0, 0, GXBGScrBase.GX_BG_SCRBASE_0x0800, GXBGCharBase.GX_BG_CHARBASE_0x10000, 0);
									G2S_SetBG2ControlText(0, 0, GXBGScrBase.GX_BG_SCRBASE_0x1000, GXBGCharBase.GX_BG_CHARBASE_0x04000);
									G2S_SetBG3ControlText(0, 0, GXBGScrBase.GX_BG_SCRBASE_0x1800, GXBGCharBase.GX_BG_CHARBASE_0x04000);
								}

								protected override void setUpTexPlttVramMng()
								{
									ds.CVram.getInstance().setupTexVramMng(393216u, 65536u, 64u, 0);

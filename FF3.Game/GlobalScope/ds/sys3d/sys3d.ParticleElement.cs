...
internal static partial class GlobalScope
{
	public static partial class ds
	{
		...
		{
			public class ParticleElement : SceneElement
			{
				private pt.Particle[] _ptcl;
				...
				public ParticleElement(SceneObject objScn)
					: base(objScn)
				{
					_ptcl = null;
					_bShow = true;
				...
				public override void draw(Scene scene)
				{
					if (_ptcl != null)
					{
						...
						sys3d_reuse_disp.drawParticles(this);
						G3_PopMtx(1);
					}
				}
				...
				public void setParticle(pt.Particle[] ptcl, uint nbPtcls)
				{
					_ptcl = ptcl;
					_nbPtcls = nbPtcls;
				}

				public pt.Particle[] getParticle()
				{
					return _ptcl;
				}

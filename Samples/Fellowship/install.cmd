...
dotnet build "%HERE%Fellowship.csproj" -c Debug -nologo -v q -o "%CLIENT%\mods\Fellowship"
if errorlevel 1 (
  echo Build failed.
  pause
  exit /b 1
...
echo.
echo Installed to %CLIENT%\mods\Fellowship - start the client, the MODS list on the title shows it.
if /i not "%1"=="-q" pause
